...
export default function UserManagement() {
  ...
  const changePasswordMutation = useMutation({
    mutationFn: async ({ id, ...passwordData }: { id: number } & z.infer<typeof passwordSchema>) => {
      const response = await apiRequest("PUT", `/api/users/${id}/password`, passwordData);
      return response.json();
    },
    onSuccess: () => {
  ...
  if (editingUser && !editForm.formState.isDirty) {
    editForm.reset({
  ...
  const onPasswordSubmit = (data: z.infer<typeof passwordSchema>) => {
    if (changingPasswordFor) {
      changePasswordMutation.mutate({ id: changingPasswordFor.id, ...data });
    }
  };
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      disabled={userItem.id === 1} // Can't edit admin
                    >
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button
                          variant="outline"
                          size="sm"
                          disabled={userItem.id === 1 || userItem.id === user?.id} // Can't delete admin or self
                        >
